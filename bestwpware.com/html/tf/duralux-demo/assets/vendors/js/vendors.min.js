...
! function(e, t) {
    ...
    class p extends t {
        ...
        static dataApiClickHandler(e) {
            var t, i, n = s(this);
            n && n.classList.contains("carousel") && (t = { ...l.getDataAttributes(n),
                ...l.getDataAttributes(this)
    ...
    class Gi extends t {
        ...
        _setListeners() {
            ...
            }, m.on(this._element.closest(".modal"), "hide.bs.modal", this._hideModalHandler), this._config.selector ? this._config = { ...this._config,
                trigger: "manual",
                selector: ""
            } : this._fixTitle()
        }

! function(t, a) {
    ...
    function i(t, e, a) {
        ...
        if (void 0 === e.startDate && void 0 === e.endDate && L(this.element).is(":text") && (o = s = null, 2 == (r = (t = L(this.element).val()).split(this.locale.separator)).length ? (o = A(r[0], this.locale.format), s = A(r[1], this.locale.format)) : this.singleDatePicker && "" !== t && (o = A(t, this.locale.format), s = A(t, this.locale.format)), null !== o) && null !== s && (this.setStartDate(o), this.setEndDate(s)), "object" == typeof e.ranges) {
            for (n in e.ranges) {
                o = "string" == typeof e.ranges[n][0] ? A(e.ranges[n][0], this.locale.format) : A(e.ranges[n][0]), s = "string" == typeof e.ranges[n][1] ? A(e.ranges[n][1], this.locale.format) : A(e.ranges[n][1]), this.minDate && o.isBefore(this.minDate) && (o = this.minDate.clone());
                var l, c = this.maxDate;
                (c = this.maxSpan && c && o.clone().add(this.maxSpan).isAfter(c) ? o.clone().add(this.maxSpan) : c) && s.isAfter(c) && (s = c.clone()), this.minDate && s.isBefore(this.minDate, this.timepicker ? "minute" : "day") || c && o.isAfter(c, this.timepicker ? "minute" : "day") || ((l = document.createElement("textarea")).innerHTML = n, i = l.value, this.ranges[i] = [o, s])
            }
            var d = "<ul>";
    ...
    return i.prototype = {
        ...
        renderCalendar: function(t) {
            ...
            for (var m = A([o, a, h, 12, n, r]), p = d = 0, f = 0; d < 42; d++, p++, m = A(m).add(24, "hour")) 0 < d && p % 7 == 0 && (p = 0, f++), e[f][p] = m.clone().hour(s).minute(n).second(r), m.hour(12), this.minDate && e[f][p].format("YYYY-MM-DD") == this.minDate.format("YYYY-MM-DD") && e[f][p].isBefore(this.minDate) && "left" == t && (e[f][p] = this.minDate.clone()), this.maxDate && e[f][p].format("YYYY-MM-DD") == this.maxDate.format("YYYY-MM-DD") && e[f][p].isAfter(this.maxDate) && "right" == t && (e[f][p] = this.maxDate.clone());
            ...
            var u = "left" == t ? this.minDate : this.startDate,
                ...
                i = (g = g + "<thead>" + "<tr>", (this.showWeekNumbers || this.showISOWeekNumbers) && (g += "<th></th>"), u && !u.isBefore(e.firstDay) || this.linkedCalendars && "left" != t ? g += "<th></th>" : g += '<th class="prev available"><span></span></th>', this.locale.monthNames[e[1][1].month()] + e[1][1].format(" YYYY"));
            if (this.showDropdowns) {
                for (var y = e[1][1].month(), k = e[1][1].year(), b = D && D.year() || this.maxYear, c = u && u.year() || this.minYear, C = k == c, v = k == b, Y = '<select class="monthselect">', w = 0; w < 12; w++)(!C || u && w >= u.month()) && (!v || D && w <= D.month()) ? Y += "<option value='" + w + "'" + (w === y ? " selected='selected'" : "") + ">" + this.locale.monthNames[w] + "</option>" : Y += "<option value='" + w + "'" + (w === y ? " selected='selected'" : "") + " disabled='disabled'>" + this.locale.monthNames[w] + "</option>";
                Y += "</select>";
                for (var P = '<select class="yearselect">', x = c; x <= b; x++) P += '<option value="' + x + '"' + (x === k ? ' selected="selected"' : "") + ">" + x + "</option>";
                i = Y + (P += "</select>")
            }
            for (g += '<th colspan="5" class="month">' + i + "</th>", D && !D.isAfter(e.lastDay) || this.linkedCalendars && "right" != t && !this.singleDatePicker ? g += "<th></th>" : g += '<th class="next available"><span></span></th>', g += "</tr><tr>", (this.showWeekNumbers || this.showISOWeekNumbers) && (g += '<th class="week">' + this.locale.weekLabel + "</th>"), L.each(this.locale.daysOfWeek, function(t, e) {
                    g += "<th>" + e + "</th>"
                }), g += "</tr></thead><tbody>", null == this.endDate && this.maxSpan && (l = this.startDate.clone().add(this.maxSpan).endOf("day"), D && !l.isBefore(D) || (D = l)), f = 0; f < 6; f++) {
                for (g += "<tr>", this.showWeekNumbers ? g += '<td class="week">' + e[f][0].week() + "</td>" : this.showISOWeekNumbers && (g += '<td class="week">' + e[f][0].isoWeek() + "</td>"), p = 0; p < 7; p++) {
                    for (var M = [], I = (e[f][p].isSame(new Date, "day") && M.push("today"), 5 < e[f][p].isoWeekday() && M.push("weekend"), e[f][p].month() != e[1][1].month() && M.push("off", "ends"), this.minDate && e[f][p].isBefore(this.minDate, "day") && M.push("off", "disabled"), D && e[f][p].isAfter(D, "day") && M.push("off", "disabled"), this.isInvalidDate(e[f][p]) && M.push("off", "disabled"), e[f][p].format("YYYY-MM-DD") == this.startDate.format("YYYY-MM-DD") && M.push("active", "start-date"), null != this.endDate && e[f][p].format("YYYY-MM-DD") == this.endDate.format("YYYY-MM-DD") && M.push("active", "end-date"), null != this.endDate && e[f][p] > this.startDate && e[f][p] < this.endDate && M.push("in-range"), this.isCustomDate(e[f][p])), S = (!1 !== I && ("string" == typeof I ? M.push(I) : Array.prototype.push.apply(M, I)), ""), B = !1, d = 0; d < M.length; d++) S += M[d] + " ", "disabled" == M[d] && (B = !0);
                    B || (S += "available"), g += '<td class="' + S.replace(/^\s+|\s+$/g, "") + '" data-title="r' + f + "c" + p + '">' + e[f][p].date() + "</td>"
                }
                g += "</tr>"
            }
            g += "</tbody></table>", this.container.find(".drp-calendar." + t + " .calendar-table").html(g)
        },
        renderTimePicker: function(t) {
            if ("right" != t || this.endDate) {
                var e, a, i = this.maxDate;
                !this.maxSpan || this.maxDate && !this.startDate.clone().add(this.maxSpan).isBefore(this.maxDate) || (i = this.startDate.clone().add(this.maxSpan)), "left" == t ? (e = this.startDate.clone(), a = this.minDate) : "right" == t && (e = this.endDate.clone(), a = this.startDate, "" == (r = this.container.find(".drp-calendar.right .calendar-time")).html() || (e.hour(isNaN(e.hour()) ? r.find(".hourselect option:selected").val() : e.hour()), e.minute(isNaN(e.minute()) ? r.find(".minuteselect option:selected").val() : e.minute()), e.second(isNaN(e.second()) ? r.find(".secondselect option:selected").val() : e.second()), this.timePicker24Hour) || ("PM" === (r = r.find(".ampmselect option:selected").val()) && e.hour() < 12 && e.hour(e.hour() + 12), "AM" === r && 12 === e.hour() && e.hour(0)), e.isBefore(this.startDate) && (e = this.startDate.clone()), i) && e.isAfter(i) && (e = i.clone());
                for (var s, n = '<select class="hourselect">', r = this.timePicker24Hour ? 0 : 1, o = this.timePicker24Hour ? 23 : 12, h = r; h <= o; h++) {
                    var l = h,
                        c = (this.timePicker24Hour || (l = 12 <= e.hour() ? 12 == h ? 12 : h + 12 : 12 == h ? 0 : h), e.clone().hour(l)),
                        d = !1;
                    a && c.minute(59).isBefore(a) && (d = !0), i && c.minute(0).isAfter(i) && (d = !0), l != e.hour() || d ? n += d ? '<option value="' + h + '" disabled="disabled" class="disabled">' + h + "</option>" : '<option value="' + h + '">' + h + "</option>" : n += '<option value="' + h + '" selected="selected">' + h + "</option>"
                }
                for (n = n + "</select> " + ': <select class="minuteselect">', h = 0; h < 60; h += this.timePickerIncrement) {
                    var m = h < 10 ? "0" + h : h,
                        c = e.clone().minute(h),
                        d = !1;
                    a && c.second(59).isBefore(a) && (d = !0), i && c.second(0).isAfter(i) && (d = !0), e.minute() != h || d ? n += d ? '<option value="' + h + '" disabled="disabled" class="disabled">' + m + "</option>" : '<option value="' + h + '">' + m + "</option>" : n += '<option value="' + h + '" selected="selected">' + m + "</option>"
                }
                if (n += "</select> ", this.timePickerSeconds) {
                    for (n += ': <select class="secondselect">', h = 0; h < 60; h++) m = h < 10 ? "0" + h : h, c = e.clone().second(h), d = !1, a && c.isBefore(a) && (d = !0), i && c.isAfter(i) && (d = !0), e.second() != h || d ? n += d ? '<option value="' + h + '" disabled="disabled" class="disabled">' + m + "</option>" : '<option value="' + h + '">' + m + "</option>" : n += '<option value="' + h + '" selected="selected">' + m + "</option>";
                    n += "</select> "
                }
                this.timePicker24Hour || (n += '<select class="ampmselect">', s = r = "", a && e.clone().hour(12).minute(0).second(0).isBefore(a) && (r = ' disabled="disabled" class="disabled"'), i && e.clone().hour(0).minute(0).second(0).isAfter(i) && (s = ' disabled="disabled" class="disabled"'), 12 <= e.hour() ? n += '<option value="AM"' + r + '>AM</option><option value="PM" selected="selected"' + s + ">PM</option>" : n += '<option value="AM" selected="selected"' + r + '>AM</option><option value="PM"' + s + ">PM</option>", n += "</select>"), this.container.find(".drp-calendar." + t + " .calendar-time").html(n)
            }
        },
        ...
        show: function(t) {
            this.isShowing || (this._outsideClickProxy = L.proxy(function(t) {
                this.outsideClick(t)
            }, this), L(document).on("mousedown.daterangepicker", this._outsideClickProxy).on("touchend.daterangepicker", this._outsideClickProxy).on("click.daterangepicker", "[data-toggle=dropdown]", this._outsideClickProxy).on("focusin.daterangepicker", this._outsideClickProxy), L(window).on("resize.daterangepicker", L.proxy(function(t) {
                this.move(t)
        ...
        clickPrev: function(t) {
            L(t.target).parents(".drp-calendar").hasClass("left") && (this.leftCalendar.month.subtract(1, "month"), !this.linkedCalendars) || this.rightCalendar.month.subtract(1, "month"), this.updateCalendars()
        },
        clickNext: function(t) {
            (L(t.target).parents(".drp-calendar").hasClass("left") || (this.rightCalendar.month.add(1, "month"), this.linkedCalendars)) && this.leftCalendar.month.add(1, "month"), this.updateCalendars()
        },
        hoverDate: function(t) {
            ...
            L(t.target).hasClass("available") && (e = (a = L(t.target).attr("data-title")).substr(1, 1), a = a.substr(3, 1), s = (L(t.target).parents(".drp-calendar").hasClass("left") ? this.leftCalendar : this.rightCalendar).calendar[e][a], n = this.leftCalendar, r = this.rightCalendar, o = this.startDate, this.endDate || this.container.find(".drp-calendar tbody td").each(function(t, e) {
                var a, i;
                L(e).hasClass("week") || (i = (a = L(e).attr("data-title")).substr(1, 1), a = a.substr(3, 1), (i = (L(e).parents(".drp-calendar").hasClass("left") ? n : r).calendar[i][a]).isAfter(o) && i.isBefore(s) || i.isSame(s, "day") ? L(e).addClass("in-range") : L(e).removeClass("in-range"))
            }))
        },
        clickDate: function(t) {
            var e, a, i, s, n, r;
            L(t.target).hasClass("available") && (s = (e = L(t.target).attr("data-title")).substr(1, 1), e = e.substr(3, 1), s = (L(t.target).parents(".drp-calendar").hasClass("left") ? this.leftCalendar : this.rightCalendar).calendar[s][e], this.endDate || s.isBefore(this.startDate, "day") ? (this.timePicker && (r = parseInt(this.container.find(".left .hourselect").val(), 10), this.timePicker24Hour || ("PM" === (n = this.container.find(".left .ampmselect").val()) && r < 12 && (r += 12), "AM" === n && 12 === r && (r = 0)), a = parseInt(this.container.find(".left .minuteselect").val(), 10), isNaN(a) && (a = parseInt(this.container.find(".left .minuteselect option:last").val(), 10)), i = this.timePickerSeconds ? parseInt(this.container.find(".left .secondselect").val(), 10) : 0, s = s.clone().hour(r).minute(a).second(i)), this.endDate = null, this.setStartDate(s.clone())) : !this.endDate && s.isBefore(this.startDate) ? this.setEndDate(this.startDate.clone()) : (this.timePicker && (r = parseInt(this.container.find(".right .hourselect").val(), 10), this.timePicker24Hour || ("PM" === (n = this.container.find(".right .ampmselect").val()) && r < 12 && (r += 12), "AM" === n && 12 === r && (r = 0)), a = parseInt(this.container.find(".right .minuteselect").val(), 10), isNaN(a) && (a = parseInt(this.container.find(".right .minuteselect option:last").val(), 10)), i = this.timePickerSeconds ? parseInt(this.container.find(".right .secondselect").val(), 10) : 0, s = s.clone().hour(r).minute(a).second(i)), this.setEndDate(s.clone()), this.autoApply && (this.calculateChosenLabel(), this.clickApply())), this.singleDatePicker && (this.setEndDate(this.startDate), !this.timePicker) && this.autoApply && this.clickApply(), this.updateView(), t.stopPropagation())
        },
        ...
        timeChanged: function(t) {
            var t = L(t.target).closest(".drp-calendar"),
                ...
                s = (isNaN(i) && (i = parseInt(t.find(".minuteselect option:last").val(), 10)), this.timePickerSeconds ? parseInt(t.find(".secondselect").val(), 10) : 0);
            this.timePicker24Hour || ("PM" === (t = t.find(".ampmselect").val()) && a < 12 && (a += 12), "AM" === t && 12 === a && (a = 0)), e ? ((t = this.startDate.clone()).hour(a), t.minute(i), t.second(s), this.setStartDate(t), this.singleDatePicker ? this.endDate = this.startDate.clone() : this.endDate && this.endDate.format("YYYY-MM-DD") == t.format("YYYY-MM-DD") && this.endDate.isBefore(t) && this.setEndDate(t.clone())) : this.endDate && ((e = this.endDate.clone()).hour(a), e.minute(i), e.second(s), this.setEndDate(e)), this.updateCalendars(), this.updateFormInputs(), this.renderTimePicker("left"), this.renderTimePicker("right")
        },

...
function _typeof(t) {
    ...
    function h(t, n, r, a, s) {
        ...
        Object.defineProperty(SVGElement.prototype, "innerHTML", {
            ...
            set: function(t) {
                ...
                try {
                    var e = new DOMParser,
                        i = (e.async = !1, "<svg xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink'>" + t + "</svg>"),
    ...
    a = {
        ...
        var a;
        return r = r || document, (a = Object.create(s)).el = r.createElementNS("http://www.w3.org/2000/svg", e), a.attr(i), (n ? n.el || n : t.svg).appendChild(a.el), a
    }, s = {
        attr: function(t, e) {
            if (void 0 !== t) {
    ...
    var a, r, s, n = function(t, e, i, n) {
        var r;
        if (n = n || document, r = Object.create(a), t = "string" == typeof t ? n.querySelector(t) : t) return (n = n.createElementNS("http://www.w3.org/2000/svg", "svg")).setAttribute("version", "1.1"), e && n.setAttribute("width", e), i && n.setAttribute("height", i), e && i && n.setAttribute("viewBox", "0 0 " + e + " " + i), t.appendChild(n), r.svg = n, r
    };
    h.easings = {
    ...
    u = {
        ...
        value: function(e, t) {
            ...
            return (e = Array.isArray(e) ? e : Object.keys(e).map(function(t) {
                return [t, e[t]]
            })).forEach(function(t) {
        ...
        value: function() {
            var e, i, n = this,
                ...
                a = this._getRadius();
            this._isIndeterminate() ? this._updateText(this.value, r, a) : (e = this.clockwise, i = this._valueToAngle(), this.graph.circle.attr("r", a), "none" !== this.animation && this.value !== this.graph.value ? h(this.animation, this.graph.value, this.value - this.graph.value, this.animationDuration, function(t) {
                n._updateText(Math.round(t), (2 * r + i) / 2, a), i = n._valueToAngle(t), n.graph.sector.attr("d", o._makeSectorPath(50, 50, a, r, i, e))
            }) : (this.graph.sector.attr("d", o._makeSectorPath(50, 50, a, r, i, e)), this._updateText(this.value, (2 * r + i) / 2, a)), this.graph.value = this.value)
        }
    }, {
        key: "_updateText",
        ...
        value: function(t, e, i, n, r, a) {
            ...
            var s = n + r * (2 * (a = !!a) - 1),
                ...
                o = t + n.x,
                t = t + s.x;
            return ["M", o, e + n.y, "A", i, i, 0, +(180 < r), +a, t, e + s.y].join(" ")
        }
    }]), o.defaults = {
        startAngle: 0,
        min: 0,
    ...
    function o(t) {
        var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
            i = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : document;
        if (_classCallCheck(this, o), !(t = "string" == typeof t ? i.querySelector(t) : t)) throw new Error("CircleProgress: you must pass the container element as the first argument");
        if (t.circleProgress) return t.circleProgress;
        (t.circleProgress = this).doc = i, t.setAttribute("role", "progressbar"), this.el = t, e = _objectSpread(_objectSpread({}, o.defaults), e), Object.defineProperty(this, "_attrs", {
            value: {},
            enumerable: !1
        }), i = "valueOnCircle" === e.textFormat ? 16 : 8, this.graph = {
            paper: n(t, 100, 100),
            value: 0
    ...
    e = function(h) {
        ...
        h.cleanData = (r = h.cleanData, function(t) {
            ...
            return t = t.split(".")[1], n = u + "-" + t, e || (e = i, i = h.Widget), h.expr[":"][n.toLowerCase()] = function(t) {
                return !!h.data(t, n)
            }, h[u] = h[u] || {}, r = h[u][t], a = h[u][t] = function(t, e) {
                ...
                _proto: h.extend({}, e),
                _childConstructors: []
            }), (s = new i).options = h.widget.extend({}, s.options), h.each(e, function(e, n) {
                function r() {
                ...
                widgetName: t,
                widgetFullName: n
            }), r ? (h.each(r._childConstructors, function(t, e) {
                var i = e.prototype;
                h.widget(i.namespace + "." + i.widgetName, a, e._proto)
            }), delete r._childConstructors) : i._childConstructors.push(a), h.widget.bridge(t, a), a
        }, h.widget.extend = function(t) {
            for (var e, i, n = o.call(arguments, 1), r = 0, a = n.length; r < a; r++)
                for (e in n[r]) i = n[r][e], n[r].hasOwnProperty(e) && void 0 !== i && (h.isPlainObject(i) ? t[e] = h.isPlainObject(t[e]) ? h.widget.extend({}, t[e], i) : h.widget.extend({}, i) : t[e] = i);
            return t
            ...
            h.fn[a] = function(i) {
                ...
                return t ? this.each(function() {
                    var t, e = h.data(this, s);
                    return "instance" === i ? (r = e, !1) : e ? h.isFunction(e[i]) && "_" !== i.charAt(0) ? (t = e[i].apply(e, n)) !== e && void 0 !== t ? (r = t && t.jquery ? r.pushStack(t.get()) : t, !1) : void 0 : h.error("no such method '" + i + "' for " + a + " widget instance") : h.error("cannot call methods on " + a + " prior to initialization; attempted to call method '" + i + "'")
                }) : (n.length && (i = h.widget.extend.apply(null, [i].concat(n))), this.each(function() {
                    var t = h.data(this, s);
                    t ? (t.option(i || {}), t._init && t._init()) : h.data(this, s, new e(i, this))
                })), r
            }
            ...
            option: function(t, e) {
                ...
                if ("string" == typeof t)
                    if (a = {}, t = (i = t.split(".")).shift(), i.length) {
                        for (n = a[t] = h.widget.extend({}, this.options[t]), r = 0; r < i.length - 1; r++) n[i[r]] = n[i[r]] || {}, n = n[i[r]];
            ...
            _on: function(r, a, t) {
                var s, o = this;
                "boolean" != typeof r && (t = a, a = r, r = !1), t ? (a = s = h(a), this.bindings = this.bindings.add(a)) : (t = a, a = this.element, s = this.widget()), h.each(t, function(t, e) {
                    function i() {
                        if (r || !0 !== o.options.disabled && !h(this).hasClass("ui-state-disabled")) return ("string" == typeof e ? o[e] : e).apply(o, arguments)
                    }
            ...
            _trigger: function(t, e, i) {
                ...
                if (i = i || {}, (e = h.Event(e)).type = (t === this.widgetEventPrefix ? t : this.widgetEventPrefix + t).toLowerCase(), e.target = this.element[0], r = e.originalEvent)
                    for (n in r) n in e || (e[n] = r[n]);
                return this.element.trigger(e, i), !(h.isFunction(a) && !1 === a.apply(this.element[0], [e].concat(i)) || e.isDefaultPrevented())
            }
        }, h.each({
            show: "fadeIn",
            hide: "fadeOut"
            ...
            h.Widget.prototype["_" + a] = function(e, t, i) {
                var n, r = (t = "string" == typeof t ? {
                    effect: t
                } : t) ? !0 !== t && "number" != typeof t && t.effect || s : a;
                "number" == typeof(t = t || {}) && (t = {
                    duration: t
                }), n = !h.isEmptyObject(t), t.complete = i, t.delay && e.delay(t.delay), n && h.effects && h.effects.effect[r] ? e[a](t) : r !== a && e[r] ? e[r](t.duration, t.easing, i) : e.queue(function(t) {
                    h(this)[a](), i && i.call(e[0]), t()
                })
            }
        }), h.widget
    }, "function" == typeof define && define.amd ? define(["jquery"], e) : e(t), t.widget("tl.circleProgress", {
        options: t.extend({}, i.defaults),
        _create: function() {
            this.circleProgress = new i(this.element[0], this.options), this.options = this.circleProgress._attrs
        },
        _destroy: function() {},
        _setOptions: function(t) {
